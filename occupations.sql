...
--Occupation. The output should consist of four columns (Doctor, Professor, 
--Singer, and Actor) in that specific order, with their respective names listed alphabetically under each column.
